...
const computeDivStyle = (props, context) => {
  ...
  const style = [{
    ...
    ":focus": {
      ...(0, _makeResponsive.default)(focusBg, "background", context.colors),
      ...(0, _makeResponsive.default)(focusTextColor, "color", context.colors),
      ...(0, _makeResponsive.default)(focusBorderColor, "border-color", context.colors),
      ...(0, _makeResponsive.default)(focusShadow, "box-shadow", context.shadows)
    },
    "::placeholder": {
      ...(0, _makeResponsive.default)(placeholderTextColor, "color", context.colors)
    },
    disabled: {

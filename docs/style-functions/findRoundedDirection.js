...
const findRoundedDirection = function (value) {
  let themeValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  if (!value) {
    return;
  }
  let style = [];
...
var _default = exports.default = findRoundedDirection;